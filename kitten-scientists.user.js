...
var run = function() {
    ...
    CraftManager.prototype = {
        ...
        getPotentialCatnip: function (worstWeather, pastures, aqueducts) {
            ...
            baseDemand *= 1 + (game.getLimitedDR(pastures * -0.005 + uniPastures * -0.0015, 1));
                ...
                for (var j = 0; j < countList.length; j++) {
                    ...
                    for (var p = 0; p < prices.length; p++) {
                        ...
                        if (source && source === 'space' && prices[p].name === 'oil') {
                            ...
                            cryoKarma = true;
                            var karmaPrice = prices[p].val * (1 - game.getLimitedDR(0.01 * game.prestige.getBurnedParagonRatio(), 1));
                        }
